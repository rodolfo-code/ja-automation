        ...
        <div className="grid md:grid-cols-2 gap-0">
          ...
          <div className="p-12 flex flex-col justify-center">
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 mt-4 flex items-center gap-2">Let's create something together 🤝</p>
              </div>
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <p 
                        className="text-gray-700 transition-colors text-sm"
                      >
                        +55 11 3996-0929
                      </p>
                    </div>
          ...
          <div className="bg-gray-50 p-12">
            <div className="space-y-6">
              <h2 className="text-2xl font-semibold text-gray-900 flex items-center gap-2">Send us a message🚀</h2>
